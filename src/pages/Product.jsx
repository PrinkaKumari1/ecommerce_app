    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>Our E-Commerce Application is a feature-rich online shopping platform designed to provide users with a seamless and intuitive shopping experience. Whether you're looking for fashion, electronics, home essentials, or more, our platform offers a wide range of products with smooth navigation and secure transactions.</p>
          <p>Easy browsing, searching, and filtering for a hassle-free shopping experience.</p>
        </div>
      </div>
